...
<div class="fixed-bottom btn-toolbar pb-2 justify-content-center">
    <div class="btn-group col-4 col-sm-4 col-md-4 col-lg-3 col-xl-2 px-1">
        <a href="/m/" class="btn btn-primary btn-block btn-lg border-dark">Добавить</a>
    </div>
    ...
    <div class="btn-group col-4 col-sm-4 col-md-4 col-lg-3 col-xl-2 px-1">
        <a href="/m/order" class="btn btn-primary btn-block disabled btn-lg border-dark disabled">Оправить</a>
    </div>
</div>
