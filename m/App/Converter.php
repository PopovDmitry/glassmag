<?php
/**
 * Класс для создания файла импорта для GPS.Order Lisec.com
 */

class App_Converter
{
    public static function generateFileContent($orderDate, $orderDelivery)
    {
        /*
        ...
        foreach($_SESSION['cart'] as $key => $order) {
            ...
            $itemString .= " " . self::setStringLength(60, $product[6]);
